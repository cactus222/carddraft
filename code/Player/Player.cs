...
abstract public class Player {
	...
	public void dayRotate() {
		if (timeLeft > 0) {
			timeLeft--;
		}
		if (this.learningSkill != Skill.NONE && timeLeft == 0) {
			this.skills.Add(this.learningSkill);
			Logger.logMessage($"this player learned {this.learningSkill.ToString("G")}");
			this.learningSkill = Skill.NONE;
		}
